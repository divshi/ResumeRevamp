  ...
  return (
    ...
    <nav className="flex flex-nowrap px-0 py-3 ">
        <ul className="flex flex-grow justify-start m-1 list-none overflow-hidden">
          <li className=" sm:mx-4"><Link to="home" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">Home <span></span></Link></li>
          <li className=" sm:mx-4"><Link to="about-us" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">About Us <span></span></Link></li>
          <li className=" sm:mx-4"><Link to="services" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">Services <span></span></Link></li>
          <li className=" sm:mx-4"><Link to="testimonials" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">Testimonials <span></span></Link></li>
