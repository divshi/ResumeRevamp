...
const Header = () => {
  ...
  return (
    ...
    <nav className="flex flex-nowrap px-0 py-3 ">
        <ul className="flex flex-grow justify-start m-1.5 list-none overflow-hidden">
          <li className="mx-1 sm:mx-4"><Link to="home" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">Home</Link></li>
          <li className="mx-1 sm:mx-4"><Link to="about-us" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">About Us</Link></li>
          <li className="mx-1 sm:mx-4"><Link to="services" smooth={true} duration={500} className="text-sm sm:text-lg hover:underline">Services</Link></li>
